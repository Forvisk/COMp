...
Decs :		Decs Dec	{addToGreateList( greatList, $2);	printf("\tadiciona lista a grande lista\n");}
			| Dec	{addToGreateList( greatList, $1);	printf("\tadiciona lista a grande lista\n");}
			;
			
Dec :		Tipe Listid TFLIN		{$2 = createLista( $1); printf("\tcriando lista de atributos\n");}
			;
...
Listid :	Listid TVIRG TID	{addIdToList( $$, $3);	printf("\t\tadicionando um id a lista\n");}
			| TID		{addIdToList( $$, $1);	printf("\t\tadicionando um id a lista\n");}
			;
